...
func Settings(view SettingsView) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 17, "</tbody></table></div><button type=\"button\" class=\"btn btn-secondary btn-sm\" onclick=\"addForgeRow()\">+ Add forge</button><div class=\"form-hint\">secret_key is the env var <strong>NAME</strong>, not the value — this is not the secret itself. Set the actual value via the deployment env / systemd unit / k8s Secret.</div></div><div class=\"form-group\"><label class=\"form-label\">notify.command</label><!--\n\t\t\t\t\tServer-rendered rows deliberately start with an extra \"\\n\"\n\t\t\t\t\tbefore the argv value (codex review round 4, PR #831): per\n\t\t\t\t\tthe HTML living standard, a browser drops the FIRST LF\n\t\t\t\t\timmediately following a <textarea> opening tag when parsing\n\t\t\t\t\tit. Without this, an argv element that itself starts with\n\t\t\t\t\t\"\\n\" (e.g. \"\\necho hello\") would render as\n\t\t\t\t\t<textarea>\\necho hello</textarea> and the browser would\n\t\t\t\t\texpose \"echo hello\" to JS's .value — the leading LF silently\n\t\t\t\t\tand permanently lost the next time the form is saved. The\n\t\t\t\t\tprepended \"\\n\" is exactly what the browser's first-LF-drop\n\t\t\t\t\tconsumes, so the original value (including a genuinely empty\n\t\t\t\t\t\"\" or one starting with \"\\n\") survives byte-for-byte. Also\n\t\t\t\t\tnote: a <textarea>'s .value additionally normalizes CRLF/CR\n\t\t\t\t\tto LF — a browser-level behavior that cannot be avoided at\n\t\t\t\t\tthe DOM level, so this field accepts LF only. See also\n\t\t\t\t\taddNotifyCommandRow() below, which writes a brand-new row's\n\t\t\t\t\t.value directly (bypassing the HTML parser, so it has no\n\t\t\t\t\tleading-LF-drop to compensate for).\n\t\t\t\t--><div id=\"notify-command-list\" class=\"settings-list\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			for _, arg := range view.NotifyCommand {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 18, "<div class=\"settings-list-row\"><textarea rows=\"1\" class=\"form-input form-input-sm notify-command-input\" spellcheck=\"false\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/settings.templ`, Line: 173, Col: 111}
				}
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var11))
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 19, "</textarea> <button type=\"button\" class=\"btn btn-sm btn-danger\" onclick=\"this.parentElement.remove()\">Remove</button></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/settings.templ`, Line: 183, Col: 93}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/settings.templ`, Line: 191, Col: 103}
			}
