...
サンドボックスの実装は `SandboxBackend` interface (`internal/sandbox/backend/`) で抽象化されており、2 backend が併存する（Phase 6、`docs/plans/phase6-container-backend.md`、全 9 PR landed 2026-07-23）:
