...
For a fuller example — and three different workflow shapes built on top of this schema — see [Workflows](../../workflows.md) and [6. The GitHub PR-driven dev workflow](../getting-started/06-dev-workflow.md).
