...
e2e_run "$E2E_BIN_DIR/boid" workspace assign "docker-proxy-build-denied" "$WS_SLUG"

task_create_output="$("$E2E_BIN_DIR/boid" task create <<'YAML'
project_id: docker-proxy-build-denied
title: Build denied
behavior: smoke
YAML
)"
