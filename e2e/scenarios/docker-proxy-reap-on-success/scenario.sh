...
WS_SLUG="docker-proxy-reap-on-success"
...
env:
  DOCKER_PROXY_TEST_CASE: reap-on-success
capabilities:
  docker: {}
YAML
...
e2e_run "$E2E_BIN_DIR/boid" workspace assign "docker-proxy-reap-on-success" "$WS_SLUG"
