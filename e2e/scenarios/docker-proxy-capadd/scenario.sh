...
e2e_run "$E2E_BIN_DIR/boid" workspace assign "docker-proxy-capadd" "$WS_SLUG"

task_create_output="$("$E2E_BIN_DIR/boid" task create <<'YAML'
project_id: docker-proxy-capadd
title: CapAdd deny
behavior: smoke
YAML
)"
