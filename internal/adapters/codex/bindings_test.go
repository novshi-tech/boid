...
// home-workspace-volume.md): codex.Adapter no longer declares any bind
// mounts. ~/.codex, ~/.volta, and the codex CLI binary itself all live
// directly in the sandbox's $HOME because Runner.Dispatch bind-mounts the
// workspace's persistent home directory there; embedded skills are
