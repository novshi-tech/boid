...
func (s apiTxStore) FindTaskByRef(ref, parentID, projectID string) (*orchestrator.Task, error) {
...
func toAPIJob(job *dispatcher.Job) *api.Job {
	...
	return &api.Job{
		...
		TerminalTitle:      job.TerminalTitle,
		DisplayNameDefault: job.DisplayNameDefault,
		Role:               job.Role,
