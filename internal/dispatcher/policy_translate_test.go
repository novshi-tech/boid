...
func TestOpConstantsMirror(t *testing.T) {
	pairs := []struct {
		...
		{orchestrator.OpBoidCardGet, string(sandbox.BoidOpCardGet)},
		{orchestrator.OpBoidCardList, string(sandbox.BoidOpCardList)},
		{orchestrator.OpBoidTaskIdentityLink, string(sandbox.BoidOpTaskIdentityLink)},
		{orchestrator.OpBoidTaskIdentityUnlink, string(sandbox.BoidOpTaskIdentityUnlink)},
		...
		{orchestrator.OpBoidAgentStart, string(sandbox.BoidOpAgentStart)},
	}
	for _, p := range pairs {
