...
//     has nothing to do with the uid the container runs as. The image bakes an
//     /etc/passwd entry for that uid, so anything that actually needs the
//     identity can ask the system for it.
