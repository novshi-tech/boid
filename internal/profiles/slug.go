...
// slugPattern requires a profile name to start with a lowercase letter or
// digit and contain only lowercase letters, digits, underscore, and hyphen
// thereafter. This excludes path separators, "..", and any other character
// that would let a profile name picked from
// --profile/BOID_PROFILE/default_profile double as a path-traversal
// payload when it is later used to build
