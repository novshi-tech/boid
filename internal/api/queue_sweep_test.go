...
func (s *sweepFakeStore) ReleaseCardRequestForTerminalTargetWithCard(targetKind, targetID string, success bool) (bool, string, error) {
	return false, "", nil
}
func (s *sweepFakeStore) ClearCardForceReleaseBarrier(cardID string) error { return nil }
